            ...
            <div className='w-100 main ' style={{ fontFamily: "arial" }} >
                ...
                <div className='col-md-12 d-flex flex-row pb-4'>
                    <div className='col-md-4 d-flex align-items-center justify-content-center'>
                        <Image src={SkullImage} width={400} />
                    </div>
                    <div className='col-md-4 d-flex align-items-center justify-content-center'>
                        <button className='glow-on-hover me-2'>Text-To-Video</button>
                        <button className='glow-on-hover ms-2'>RealTime Video-To-Text</button>
                    </div>
                    <div className='col-md-4 d-flex align-items-center justify-content-center'>
                        <Image src={xyro} width={200} />
                    </div>
